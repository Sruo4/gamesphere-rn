...
const GameDetail = () => {
  ...
  const { result: gameResult = "{}" } = route.params as RouteParams;
  ...
  useEffect(() => {
    fetch(
      `https://store.steampowered.com/api/appdetails?appids=${result.appid}`
    )
  ...
  return (
    ...
    >
      ...
      {headerImage && (
        <Image
        source={{ uri: headerImage || result.image_link }}
        style={{
          width: 320,
          height: 150,
          alignSelf: "center",
      ...
      >
        ...
        <View
          style={{ width: 1, backgroundColor: "#BFBFBF", marginHorizontal: 5 }}
        />
        <View style={{ flex: 1 }}>
          <Text>开发商:</Text>
          <View style={{ alignItems: "center" }}>
